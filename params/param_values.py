...
def check_for_errors(args, pretrain=False, **kwargs):
    ...
    if not pretrain:
        ...
        if hasattr(args, 'importance_weighting') and args.importance_weighting=='si' and \
            ...
            raise NotImplementedError('SI-based importance weighting not supported with parameter pre-conditioning.')       # -FROMP has a limited range of options it can be combined with
