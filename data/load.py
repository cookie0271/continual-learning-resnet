...
def get_dataset(name, type='train', download=True, capacity=None, permutation=None, dir='./store/datasets',
    ...
    dataset_kwargs = dict(
        ...
        download=download if data_name != "TinyImageNet" else False,
    )
...
def get_context_set(name, scenario, contexts, data_dir="./store/datasets", only_config=False, verbose=False,
